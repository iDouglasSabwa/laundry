...
<html lang="zxx">
<head>
	<title>User Register | Laun</title>
	<meta charset="UTF-8">
...
<body>
	...
	<!-- Contact section -->
	<section class="contact-section" style="background-image: linear-gradient(purple, black);" >
		<div class="container">
			<div class="row">
				<div class="col-lg-8 col-sm-12 contact-info" style="margin: auto;  width: 100%;padding-bottom: 30px">
					<h3 class="text-white">Signing up as Client</h3>
					
					<form class="contact-form" action="../helpers/client_register.php" method="post" autocomplete="off">
						...
						<select name="zone" required="required">
							<option value="">Select residential zone...</option>
