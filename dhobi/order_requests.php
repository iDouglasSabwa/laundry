...
<html lang="zxx">
<head>
	<title>Order Requests | Laun</title>
	<meta charset="UTF-8">
			...
			<div class="row">
				<div class="col-lg-8" style="margin: auto; width: 100%;">
					<div class="cart-table">
						...
						<div class="cart-table-warp">
							<table>
							<tbody>
								<?php requestDhobis($id);?>
							</tbody>
						</table>
						</div>
						<div class="total-cost">
							<?php requestClientSum($id);?>
						</div>
					</div>
				</div>
				<!-- <div class="col-lg-4 card-right">
					<form class="promo-code-form">
						...
						<a href="" class="site-btn">Accept All</a>
					<a href="" class="site-btn sb-dark">Decline All</a>
					</form>
